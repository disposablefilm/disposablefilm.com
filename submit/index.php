...
<div id="submission">
  ...
  <div class="row">
    ...
    <div class="col-md-6">
      ...
      <h4>DANIELS</h4>
      <img src="{{ 'daniel_scheinert.png' | asset_path }}" width="80" height="80" alt="Daniel Scheinert" />
      <img src="{{ 'daniel_kwan.png' | asset_path }}" width="80" height="80" alt="Daniel Kwan" />
      ...
      <img src="{{ 'kirsten_lepore.png' | asset_path }}" width="80" height="80" alt="Kirsten Lepore" />
      ...
      <img src="{{ 'sascha_ciezata.png' | asset_path }}" width="80" height="80" alt="Sascha Ciezata" />
      ...
      <img src="{{ 'matthew_lessner.png' | asset_path }}" width="80" height="80" alt="Matthew Lessner" />
      ...
      <img src="{{ 'stefan_nadelman.png' | asset_path }}" width="80" height="80" alt="Stefan Nadelman" />
      ...
      <h4>Bruno Smadja</h4>
      <img src="{{ 'bruno_smadja.png' | asset_path }}" width="80" height="80" alt="Bruno Smadja" />
