...
<div id="submission">
      ...
      ?>
          <div id="vimeo_submit">
            <table cellpadding="0" cellspacing="0" border="0">
              <tr>
                <td class="vimeo_logo"><img src="{{ 'jurors/vimeo_lrg.gif' | asset_path }}" alt="Vimeo" width="34" height="30" style="padding: 0; margin: 0;"></td>
  ...
  <div class="row">
    ...
    <div class="col-md-6">
      ...
      <img src="{{ 'jurors/sascha_ciezata.png' | asset_path }}" width="80" height="80" alt="Sascha Ciezata" />
      ...
      <img src="{{ 'jurors/matthew_lessner.png' | asset_path }}" width="80" height="80" alt="Matthew Lessner" />
      ...
      <img src="{{ 'jurors/stefan_nadelman.png' | asset_path }}" width="80" height="80" alt="Stefan Nadelman" />
      ...
      <h4>Bruno Smadja</h4>
      <img src="{{ 'jurors/bruno_smadja.png' | asset_path }}" width="80" height="80" alt="Bruno Smadja" />
